...
ActiveRecord::Schema[7.0].define(version: 2024_11_16_173703) do
  ...
  create_table "comidas", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["lugar_id"], name: "index_comidas_on_lugar_id"
  end
  ...
  create_table "lugars", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "user_id"
    t.index ["user_id"], name: "index_lugars_on_user_id"
  end
  ...
  create_table "opinions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["comida_id"], name: "index_opinions_on_comida_id"
    t.index ["lugar_id"], name: "index_opinions_on_lugar_id"
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["comida_id"], name: "index_reviews_on_comida_id"
    t.index ["lugar_id"], name: "index_reviews_on_lugar_id"
